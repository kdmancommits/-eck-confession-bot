...
body { width: 540px; height: 675px; background: #f5ede0; }
...
.tag { padding: 0.18rem 0.7rem; border: 1px solid #b8862a; color: #3a1f08; font-size: 0.72rem; border-radius: 2px; font-family: 'Cormorant Garamond', serif; background: rgba(184,134,42,0.15); }
...
<div class="card">
  ...
  try {
    const browser = await puppeteer.launch({
      args: chromium.args,
      defaultViewport: { width: 540, height: 675 },
    ...
    formData.append("photo", imageBuffer, { filename: "confession.png", contentType: "image/png" });
    formData.append("caption", `${num} | ${gender}${age ? " | " + age + " বছর" : ""}`);
